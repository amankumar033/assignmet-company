    ...
    <Layout>
      <div className="space-y-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 text-lg">Welcome to your employee management dashboard</p>
        </div>
        ...
        {/* Employee Table */}
        {data && !loading && (
          <div className="card-float overflow-hidden hover:scale-[1.02] hover:-translate-y-2 transition-all duration-500">
            <div className="px-6 py-5 border-b border-gray-100">
              <h2 className="text-xl font-semibold text-gray-900">Recent Employees</h2>
              <p className="text-sm text-gray-500 mt-1">Latest employee records</p>
            </div>
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-100">
                ...
                <tbody className="bg-white divide-y divide-gray-100">
                  {data.employees.employees.map((employee: any) => (
                    <tr
                      key={employee.id}
                      className="relative transition-all duration-300 ease-out transform hover:scale-[1.01] hover:-translate-y-0.5 hover:shadow-soft-lg border border-transparent hover:border-blue-100 rounded-lg group cursor-pointer bg-white hover:bg-blue-50/30"
                    >
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-700 group-hover:text-gray-900">{employee.id}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-700 group-hover:text-gray-900">{employee.name}</td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-600 group-hover:text-gray-800">{employee.age}</td>
                      <td className="px-6 py-4 whitespace-nowrap">
                        <span className="px-3 py-1.5 inline-flex text-xs font-semibold rounded-lg bg-blue-50 text-blue-700 group-hover:bg-blue-100 transition-colors duration-200">
                          {employee.class}
                        </span>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-700 group-hover:text-gray-900">{employee.attendance}%</td>
                    </tr>
                  ))}
                </tbody>
              </table>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              <div className="flex flex-col items-start space-y-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900 mb-1">Add New User</p>
            ...
            >
              <div className="flex flex-col items-start space-y-3">
                ...
                <div>
                  <p className="font-semibold text-gray-900 mb-1">Create Service</p>
                  <p className="text-sm text-gray-500">Add new service offerings</p>
                </div>
              </div>
            </Link>
